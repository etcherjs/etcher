...
const questions = [
    ...
    },
    {
        ...
        name: "overwrite",
        message: () => {
            return `The directory '${projectName}' already exists. ${lightRed("Do you want to overwrite it?")}`;
        },
    },
    {
        type: (_, { overwrite }) => {
...
const createProject = async () => {
    ...
    if (!fs.existsSync(projectPath)) {
        ...
        fs.writeFileSync(path.resolve(projectPath, "etcher.config.js"), etcherConfig);
